...
log "  2. Build images from ${REPO_DIR}/docker/:"
log "       docker build -f docker/python/Dockerfile -t abs-tools-python ."
log "       docker build -f docker/epub/Dockerfile   -t abs-tools-epub   ."
log "  3. Enable timers:"
...
log "    abs-tools-python abs-auto-match --full"
log "  docker run --rm --user 1000:1000 --env-file /etc/abs-tools/abs-tools.env \\"
log "    -v /var/log/abs-tools:/var/log/abs-tools -v /var/lib/abs-tools:/var/lib/abs-tools \\"
log "    abs-tools-python abs-auto-match --full --library audiobooks"
log "  docker run --rm --user 1000:1000 --env-file /etc/abs-tools/abs-tools.env \\"
log "    -v /var/log/abs-tools:/var/log/abs-tools -v /var/lib/abs-tools:/var/lib/abs-tools \\"
log "    abs-tools-python abs-chapter-match --full"
